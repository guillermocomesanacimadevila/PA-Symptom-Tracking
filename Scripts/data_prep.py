...
def main():
    ...
    df["dY_next"] = df["Ystar_next_day"] - df["U_t"]
    ...
    data = df.dropna(subset=["Ystar_next_day","dY_next"]).copy()
    ...
    label = "dY_next"
    ml_cols = [ID,DAY] + features + [label,"Ystar_next_day"]
    ...
    print(out_ml)
    print(len(data), data[ID].nunique())
