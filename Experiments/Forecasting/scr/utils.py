...
def build_feature_label_matrices(
    ...
    leak_exact = {
        "Ystar_next_day", "dY_next",
        "Ustar_next_day", "dU_next",
        "Wstar_next_day", "dW_next",
        "Sstar_next_day", "dS_next",
    }
    ...
    drop_cols = [c for c in X.columns if c in leak_exact or c.startswith(leak_prefixes)]
    if drop_cols:
